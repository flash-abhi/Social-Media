  ...
  return (
    <div className='w-full h-[80px] flex items-center justify-between border-b-2 border-gray-800'>
        <div className="flex items-center gap-2 ">
          <div className="w-11 h-11 border-2 border-black rounded-full cursor-pointer overflow-hidden">
            <img
        ...
        <button className="px-[10px] w-[90px] py-[5px] h-[35px] bg-white rounded-2xl">Follow</button>
    </div>
  )
}
